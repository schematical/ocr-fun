...
module.exports = function(app){
     ...
     var route = app.njax.routes.image = {
        ...
        init:function(uri){
            ...
            app.all(uri + '/:image', route.render_detail);
            app.all(uri + '/:image/edit', route.render_edit);
        ...
        render_list:function(req, res, next){
            ...
            async.series([
                function(cb){
                        ...
                        app.model.Image.find(query, function(err, _images){
                ...
                function(cb){
                    res.render('model/image_list', res.locals.symbols);
                }
            ]);
        },
        render_detail:function(req, res, next){
            ...
            res.render('model/image_detail', req.image.toObject());
        },
