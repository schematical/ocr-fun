...
module.exports = function(app){
     ...
     var route = app.njax.routes.library = {
        ...
        init:function(uri){
            ...
            app.all(uri + '/:library', route.render_detail);
            app.all(uri + '/:library/edit', route.render_edit);
        ...
        render_list:function(req, res, next){
            ...
            async.series([
                ...
                function(cb){
                    res.render('model/library_list', res.locals.symbols);
                }
            ]);
        },
        render_detail:function(req, res, next){
            ...
            res.render('model/library_detail', req.library.toObject());
        },
