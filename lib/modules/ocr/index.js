                ...
                function(cb){
                    ...
                    async.eachSeries(
                        ...
                        function(row, _cb){
                            ...
                            async.eachSeries(
                                Object.keys(grid[row]),
                                function(col, __cb){
                                    console.log("Building Clusters: ", row, col);
                                    /*-------------Run cluster tests----------------------*/
                                    ...
                                    if(
                                        ...
                                        return cluster.expand(pixel, function(err, data){
                                            ...
                                            process.nextTick(function(){
                                                ...
                                                console.log("Expanded:" , row, col);
                                                return __cb();
                                            });
                                        });
                                    }
                                    process.nextTick(function(){
                                        console.log("Not building cluster" , row, col);
                                        return __cb();
                                    });
                                },
                                function(){
                                    console.log("Were in to deep");
                                    return _cb();
                                }
                            );
